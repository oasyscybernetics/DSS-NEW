...
class Settings extends Base
{
    ...
    public function update()
    {
        ...
        if ($this->getConfig()->isSettingEditable('APK_VERSION')) {
            $this->getConfig()->changeSetting('APK_VERSION', $this->getSanitizer()->getString('APK_VERSION'));
        }
        
        if ($this->getConfig()->isSettingEditable('APK_DOWNLOAD_URL')) {
            $this->getConfig()->changeSetting('APK_DOWNLOAD_URL', $this->getSanitizer()->getString('APK_DOWNLOAD_URL'));
        }
