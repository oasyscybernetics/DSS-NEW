...
class Display extends Base
{
    ...
    function grid()
    {
        ...
        $filter = [
            ...
            'firstAccessed' => ($this->getSanitizer()->getDate('firstAccessed') != null) ? $this->getSanitizer()->getDate('firstAccessed')->format('U') : null,
        ];
        ...
        foreach ($displays as $display) {
            ...
            if ($this->isApi()) {
                $display->firstAccessed = $this->getDate()->getLocalDate($display->firstAccessed);
    ...
    public function addViaCode()
    {
        ...
        try {
            // When the valid code is submitted, it will be sent along with CMS Address and Key to Authentication Service maintained .
