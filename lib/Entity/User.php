...
class User implements \JsonSerializable
{
    ...
    {
        $this->getLog()->audit(sprintf('Reassign all to %s', $user->userName));

        $this->load(true);

        $this->getLog()->audit(sprintf('There are %d children', $this->countChildren()));
    ...
    public function save($options = [])
    {
        ...
        //$this->getLog()->audit('User', '', 'Saving user', ['']);
    ...
    public function delete()
    {
        ...
        $this->getLog()->audit('User', $this->userId, 'Deleting user', ['userId' => $this->userId]);
    ...
    private function add()
    {
        ...
        $this->getLog()->audit('User', $this->userId, 'Saving user', ['userId' => $this->userId]);
        // Add the user group
        /* @var UserGroup $group */
    ...
    {
        //$this->getLog()->audit('Update userId %d.', $this->userId);
        $this->getLog()->audit('User', $this->userId, 'User Updated Successfully', ['userId' => $this->userId]);
    ...
    {
        //$this->getLog()->audit('Update user password. %d', $this->userId);
        $this->getLog()->audit('User', $this->userId, 'Update user password', ['userId' => $this->userId]);
